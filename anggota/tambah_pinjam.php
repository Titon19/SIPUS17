    ...
    if (isset($_POST['submit'])) {
        ...
        if ($jumlah_buku <= 0) {
            ...
            if (checkJumlahPeminjaman($koneksi, $id_anggota) >= 3) {
                echo "<script language='JavaScript'>alert('Maaf, Anda sudah mencapai batas maksimal 3 kali peminjaman. Silahkan datang ke perpustakaan dan kembalikan salah satu buku terlebih dahulu!');</script>";
            } else {
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post"> 
                                    ...
                                    <input name="id_pinjamKeluar" class="form-control form-control-sm" disabled type="input" value="<?php echo $no_trans?>" aria-label=".form-control-sm example" >
                                    <input name="id_pinjam" class="form-control form-control-sm" type="hidden" value="<?php echo $no_trans?>" aria-label=".form-control-sm example" >

                                    <input name="id_anggota" class="form-control form-control-sm" type="hidden" value="<?php echo $_SESSION['id_anggota']; ?>" aria-label=".form-control-sm example">
                                    <label for="" class="mb-1 mt-1"><strong>Buku</strong></label>
                                    <select name="id_buku" class="form-select" id="single-select-field2" aria-label="Default select example" required>
                                    ...
                                    <input id="tgl_pinjam" name="tgl_pinjam" class="form-control form-control-sm" type="date" placeholder="Masukkan Tgl Pinjam" aria-label=".form-control-sm example" required>
                                    
                                    <label for="" class="mb-1 mt-1"><strong>Tgl Kembali</strong></label>
                                    <input readonly id="tgl_kembali" name="tgl_kembali" class="form-control form-control-sm" type="date" placeholder="Masukkan Tgl Kembali" aria-label=".form-control-sm example" required>
                                    

                                    <input name="tgl_kembalikan" class="form-control form-control-sm" type="hidden" placeholder="Masukkan Tgl Kembali" aria-label=".form-control-sm example" required>

                                    
                                    <input type="hidden" name="selected_no_wa" id="selected_no_wa" value="">
                                    <a href="detail_pinjam.php" ><input type="submit" name="submit" value="Simpan" class="btn btn-primary mt-1"></a>
                                    <input type="reset" name="reset" value="Reset" class="btn btn-secondary mt-1">
                                    <a href="tampil_peminjaman.php"><input type="button" name="submit" value="Batal" class="btn btn-danger mt-1"></a>
                                </form>
                            </div>
                        </div>
                    </div>
