                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                <?php
                                $id_anggotas = $_SESSION['id_anggota'];
                                $tampilbuku = mysqli_query($koneksi, "SELECT
                                peminjaman.id_pinjam, 
                                peminjaman.id_anggota,
                                anggota.nisn, 
                            ...
                            FROM
                                ...
                                ON 
                                    peminjaman.id_buku = buku.id_buku
                                    WHERE anggota.id_anggota = '$id_anggotas' AND (peminjaman.`status` = 'Dipinjam'
                                     OR peminjaman.`status` = 'Diperpanjang' 
                                     OR peminjaman.`status` = 'Tunggu Approve Perpanjang' 
                                     OR peminjaman.`status` = 'Tunggu Approve Peminjaman')");
                                $no = 1;
                                while ($data = mysqli_fetch_array($tampilbuku)) {
                                        ...
                                        <td>
                                            ...
                                            if ($status !== 'Dikembalikan') {
                                                ...
                                                if (isset($_POST['perpanjangPeminjaman'])) {
                                                    ...
                                                    $perpanjangan = mysqli_query($koneksi, "UPDATE peminjaman SET tgl_pinjam='$tgl_pinjam_sekarang', tgl_kembali='$perpanjanganKembali', `status`='Tunggu Approve Perpanjang' WHERE id_pinjam='$id_pinjam2'");
                                                ...
                                                <form action="" method="POST">
                                                    <?php
                                                    $tgl_sekarangs = date("Y-m-d");
                                                    $tgl_kembalis = date('Y-m-d', strtotime($tgl_kembali));
                                                    if ($status != "Tunggu Approve Perpanjang") {
                                                        if ($tgl_kembalis <= $tgl_sekarangs) {
                                                            // echo var_dump($tgl_sekarangs);
                                                            ?>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Apakah anda yakin ingin memperpanjang peminjaman ini?,
                                                                        jika yakin,
                                                                        <br>Bayar denda terlebih dahulu agar mendapatkan approve
                                                                        perpanjang,
                                                                        jika terkena denda.<br>
                                                                        Jika anda perpanjang tepat waktu di tanggal kembali,
                                                                        maka anda akan mendapatkan approve langsung oleh Admin
                                                                        atau Petugas.
                                                                    </p>
                                                                </div>
                                                ...
                                                <a href="hapus_pinjam.php?id_pinjam=<?php echo $id_pinjam; ?>"
