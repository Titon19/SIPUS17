    ...
    if (isset($_POST['submit'])) {
        ...
        if ($jumlah_buku <= 0) {
            ...
            if (checkJumlahPeminjaman($koneksi, $id_anggota) >= 3) {
                ...
                $query = mysqli_query($koneksi, "INSERT INTO peminjaman (id_pinjam, id_anggota, id_buku, tgl_pinjam, tgl_kembali, terlambat, denda, status) 
                          VALUES ('$no_pinjam', '$id_anggota', '$id_buku', '$tgl_pinjam', '$tgl_kembali', '$terlambat1', '$denda1', 'Dipinjam')");
...
<html lang="en">
    <head>
        ...
        <title>Tambah Data Transaksi Peminjaman Buku</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Tambah Transaksi Peminjaman Buku</h1>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post"> 
                                    ...
                                    <select name="id_anggota" class="form-select" id="single-select-field" data-placeholder="Cari Anggota" required>
                                        <option value=""></option>
                                        <?php
                                        ...
                                        ?>
                                        <option value="<?php echo $id_anggota ?>"><?php echo $id_anggota . " | " . $nisn . " | " . $nama . " | " . $jurusan . " | ". $no_wa?></option>
