...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($tgl_mulai == "" || $tgl_akhir == "") {
        ...
        header("location:../laporan_kembali.php?tgl_mulai=$tgl_mulai&tgl_akhir=$tgl_akhir");
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Cetak Laporan Data Transaksi Pengembalian Buku</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Cetak Laporan Data Transaksi Pengembalian Buku</h1>
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table me-1"></i>
                        Cetak Laporan Data Transaksi Pengembalian Buku
                    </div>
                    <div class="card-body">
                        <form method="POST" action="../laporan_kembali.php" target="_blank">
