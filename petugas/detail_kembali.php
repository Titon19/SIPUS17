...
<head>
    ...
    <title>Detail Transaksi Pengembalian Buku</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Detail Transaksi Pengembalian Buku</h1>
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table me-1"></i>
                        Detail Transaksi Pengembalian Buku
                    </div>
                    <div class="card-body">
                        <form action="" method="post">
                            <label for="id_pinjam" class="mb-1 mt-1"><strong>No Pinjam</strong></label>
                            <input id="id_pinjam" name="id_pinjam" class="form-control form-control-sm" type="text"
                                value="<?php echo $id_pinjam ?>" disabled aria-label=".form-control-sm example">
                            <label for="" class="mb-1 mt-1"><strong>Peminjam</strong></label>
                            <select name="nisn" class="form-select" id="single-select-field" disabled
                                data-placeholder="Cari Anggota">
                                <?php
                            ...
                            <input id="tgl_pinjam" name="tgl_pinjam" class="form-control form-control-sm" disabled
                                type="date" value="<?php echo $tgl_pinjam ?>" aria-label=".form-control-sm example">

                            <label for="tgl_kembali" class="mb-1 mt-1"><strong>Tgl Kembali</strong></label>
                            <input id="tgl_kembali" name="tgl_kembali" class="form-control form-control-sm" disabled
                                type="date" value="<?php echo $tgl_kembali ?>" aria-label=".form-control-sm example">

                            <label for="tgl_dikembalikan" class="mb-1 mt-1"><strong>Tgl Dikembalikan</strong></label>
                            <input id="tgl_dikembalikan" name="tgl_dikembalikan" class="form-control form-control-sm"
                                disabled type="date" value="<?php echo $tgl_dikembalikan ?>"
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo "<span class='badge rounded-pill text-bg-secondary'>$status</span>"
                                                ?>
                                        </td>
                                    </tr>
                                    <?php ?>
                            ...
                            <a href="tampil_pengembalian.php"><input type="button" name="kembali" value="Kembali"
