...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($tgl_mulai == "" || $tgl_akhir == "") {
        ...
        header("location:../laporan_pinjam.php?tgl_mulai=$tgl_mulai&tgl_akhir=$tgl_akhir");
    }
}
?>
<!DOCTYPE html>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Cetak Laporan Data Transaksi Peminjaman Buku</h1>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="../laporan_pinjam.php" target="_blank">
