...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO buku_masuk (id_buku, qty, tgl_masuk) 
              VALUES ('$id_buku', '$qty', '$waktuSaatIni')");
              
    if ($query) {
        // Jika input berhasil disimpan
        echo "<script language='JavaScript'>alert('Data Berhasil Disimpan');document.location='tampil_bukumasuk.php';</script>";
...
<html lang="en">
    <head>
        ...
        <title>Tambah Data Buku Masuk</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Tambah Stok Data Buku Masuk</h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Tambah Stok Data Buku Masuk
                            </div>
                            <div class="card-body">
                                ...
                                <select name="id_buku" class="form-select" id="single-select-field" aria-label="Default select example">
                                    <option value="">-- Pilih Buku --</option>
                                        <?php
                                                ...
                                                <a href="tampil_bukumasuk.php" ><input type="submit" name="submit" value="Simpan" class="btn btn-primary mt-1"></a>
                                                <input type="reset" name="reset" value="Reset" class="btn btn-secondary mt-1">
                                                <a href="tampil_bukumasuk.php"><input type="button" name="submit" value="Batal" class="btn btn-danger mt-1"></a>
