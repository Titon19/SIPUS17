        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <a href="tambah_buku.php" class="btn btn-success mb-1">Tambah Data +</a>
                            ...
                            FROM
                                ...
                                while ($data = mysqli_fetch_array($tampilbuku)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_buku.php?id_buku=<?php echo $id_buku ?>"
                                                class="btn btn-primary">Edit</a>
                                            <a href="hapus_buku.php?id_buku=<?php echo $id_buku ?>&action=hapus"
