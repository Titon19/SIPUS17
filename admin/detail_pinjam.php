...
<html lang="en">
    <head>
        ...
        <title>Detail Transaksi Peminjaman Buku</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Detail Transaksi Peminjaman Buku</h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Detail Transakasi Peminjaman Buku
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                           ...
                                           <?php } ?>
                                            ...
                                            <a href="tampil_peminjaman.php"><input type="button"  value="Kembali" class="btn btn-danger mt-1"></a>
                                </form>
                            </div>
                        </div>
                    </div>
