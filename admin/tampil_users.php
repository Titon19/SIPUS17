        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <a href="tambah_users.php" class="btn btn-success mb-1">Tambah Data +</a>
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                $tu = mysqli_query($koneksi, "SELECT * FROM users");
                                $no = 1;
                                while ($data = mysqli_fetch_array($tu)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_users.php?id_user=<?php echo $id ?>" class="btn btn-primary"
                                                style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem; width:100%;">Edit</a>
                                            <br>
                                            <a href="hapus_users.php?id_user=<?php echo $id ?>&action=hapus"
